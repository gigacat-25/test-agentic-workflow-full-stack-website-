...
-- ============================================================
-- RECEPTIONIST ALERTS (Doctor calling next patient)
-- ============================================================
CREATE TABLE IF NOT EXISTS receptionist_alerts (
  id TEXT PRIMARY KEY,
...
CREATE INDEX idx_alerts_status ON receptionist_alerts(status);
...
VALUES (
  ...
  'Dr. Keshav',
  'doctor',
  'thejaswinp6@gmail.com',
  '$2a$10$JdxNJgtk990L8dXhoBZ3Qeb8Q5UkueprPFRWnFzOK.7eHbiqDNqZ6'
);
