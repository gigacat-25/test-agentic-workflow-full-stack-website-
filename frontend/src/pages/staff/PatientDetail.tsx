...
export default function PatientDetail() {
  ...
  const [patient, setPatient] = useState<StaffPatient | null>(null);
  ...
  if (error || !patient) {
    return (
      <div className="error-container" style={{ margin: '20px 0' }}>
        ...
        <br />
        <Link to="/staff/dashboard" className="btn btn-tertiary btn-sm" style={{ marginTop: '12px' }}>Back to Dashboard</Link>
      </div>
    );
  }
  ...
  return (
    <div>
      <div style={{ marginBottom: '20px' }}>
        <Link to="/staff/dashboard" style={{ color: 'var(--body-mid)', fontSize: '14px', fontWeight: '500' }}>
